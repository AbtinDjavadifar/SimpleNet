...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 26 19:01:33 2018

@author: kashishg

Training forst attemp for demo for Dr. Voggenhreiter
- Simple CNN Net 62 layers 
- 200 epochs
- MiniDataset
"""
import torch
...
train_set = torchvision.datasets.ImageFolder(root='./Training_Images/Training_Set/',transform=train_transformations)
...
for epoch in range(num_epochs):
    ...
    print("Background {}, Fabric {}, Gripper {}, Wrinkle {}".format(background_acc, fabric_acc, gripper_acc, wrinkle_acc))
